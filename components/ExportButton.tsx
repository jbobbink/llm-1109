...
export const ExportButton: React.FC<ExportButtonProps> = ({ results, config }) => {
    ...
    return (
        <button 
            ...
            className="bg-gray-800 hover:bg-gray-700 text-green-400 font-bold py-2 px-4 rounded-lg transition-colors flex items-center space-x-2 border border-gray-600"
        >
